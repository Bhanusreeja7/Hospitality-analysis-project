...
- A global industry focused on providing guest experiences through lodging, event planning, and theme parks.
- Operating with a massive international user base that relies on high-quality service and seamless booking experiences.
 
 Project Aim:
 
 - To analyze and derive actionable insights from hotel performance, guest feedback, and booking trends data

Objectives and Goals:

- Analyze hospitality performance by identifying key performance indicators like Revenue Per Available Room (RevPAR).
- Use data visualization to derive strategic insights that improve guest satisfaction and streamline operational efficiency.
